...
namespace CMS_CORE_NG.Areas.Admin.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(string returnUrl = null)
        {
            ...
            {
                Log.Error("An error occured while login {Error} {StackTrace} {InnerException} {Source}",
        ...
        public async Task<IActionResult> Login([FromBody] LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    _cookieSvc.SetCookie(AccessToken, jwtToken.Token, expireTime);
        ...
        public async Task<IActionResult> Logout()
        {
            try
            {
                ...
                if (userId != null)
                {
                    ...
                    var unprotectToken = protector.Unprotect(userId);

                    var rt = _db.Tokens.FirstOrDefault(t => t.UserId == unprotectToken);
            ...
            {
                _cookieSvc.DeleteAllCookies(cookiesToDelete);
                Log.Error("An error occured while Logout {Error} {StackTrace} {InnerException} {Source}",
                    ex.Message, ex.StackTrace, ex.InnerException, ex.Source);
            }
