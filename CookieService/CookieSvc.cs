...
namespace CookieService
{
    public class CookieSvc : ICookieSvc
    {
        ...
        public string GetUserIP()
        {
            ...
            {
                Log.Error("An error occurred in GetUserIP {Error} {StackTrace} {InnerException} {Source}",
        ...
        public string GetUserCountry()
        {
            ...
            {
                Log.Error("An error occurred while GetUserCountry  {Error} {StackTrace} {InnerException} {Source}",
                    ex.Message, ex.StackTrace, ex.InnerException, ex.Source);
            }
        ...
        public string GetUserOS()
        {
            ...
            {
                Log.Error("An error occurred while GetUserOS  {Error} {StackTrace} {InnerException} {Source}",
                    ex.Message, ex.StackTrace, ex.InnerException, ex.Source);
            }
            return userOs;
        }
